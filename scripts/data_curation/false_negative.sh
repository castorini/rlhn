...
export DATASETS=("fiqa" "msmarco_passage")

#### Example of stage 1 using GPT-4o-mini
for dataset in "${DATASETS[@]}"; do
    python -m false_negative \
        --model_name_or_path gpt-4o-mini \
        --subset ${dataset} \
        --train_dataset RLHN/bge-retrieval-data-default-test-50 \
        --output_dir ./output/bge-retrieval-data-default-test-50/ \
        --output_file ${dataset}.stage_1.gpt-4o-mini.jsonl \
...
# export OMP_NUM_THREADS=1
# export DATASETS=("fiqa" "msmarco_passage" "fever" "hotpotqa")
# for dataset in "${DATASETS[@]}"; do
#     python -m false_negative \
