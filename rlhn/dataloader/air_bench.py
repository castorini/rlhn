## Modified the script from https://github.com/AIR-Bench/AIR-Bench to make it compatible with BEIR benchmark

import datasets
import os

class AirBenchDataLoader:
    def __init__(self, benchmark_version: str, cache_dir: str = None):
        self.benchmark_version = benchmark_version
        self.cache_dir = cache_dir
    
    def load(self, task_type: str, domain: str, language: str, dataset_name: str, split: str = 'dev'):
        qrels = self.load_qrels(task_type, domain, language, dataset_name, split)
        corpus = self.load_corpus(task_type, domain, language, dataset_name)
        queries = self.load_queries(task_type, domain, language, dataset_name, split)
